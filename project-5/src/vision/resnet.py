...
class ResNet(nn.Module):
    def __init__(
        self, block: Union[BasicBlock, Bottleneck], layers: List[int], num_classes: int = 1000, deep_base: bool = True
    ) -> None:
    ...
    def _make_layer(self, block: Union[BasicBlock, Bottleneck], planes: int, blocks: int, stride: int = 1):
        """
        Args:
